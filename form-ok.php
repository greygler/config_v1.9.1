...
<html lang="ru">
    <head>
        ...
        <style type="text/css">
            ...
            h2 {margin: 0; padding: 0; font-size: 36px;line-height: 44px;color: #313e47;text-align: center; font-weight: bold; Color: red;}
            a {color: #69B9FF;}
			.ok{color: green;font-size: 8em;margin-top: 30px;}
            ...
            .fail {margin: 10px 0 20px 0px;text-align: center;}
            .email {position: relative;text-align: center;margin-top: 40px;}
            .email input {height: 30px;width: 200px;font-size: 14px;padding-right: 10px; padding-left: 10px;outline: none;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;border: 1px solid #B6B6B6;margin-bottom: 10px;}
            .block_success {max-width: 960px;padding: 20px 30px 70px 30px;margin: -50px auto;}
...
<div class="ok success"> &#10004;</div>		
            ...
            <div class="success">
                <ul class="list_info">
                    <li><span>Ф.И.O.:  </span><span id="client"><?= $_SESSION['name'] ?></span></li>
                    <li><span>Телефон: </span><span id="tel"><?= $_SESSION['phone'] ?></span></li>
                </ul>
...
<? if ($upsel){
	echo ("<hr width: 40%> <h3 class=\"red success\">{$upsel_title}</h3>");
